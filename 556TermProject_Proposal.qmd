...
Each variable has 309 observations with no missing data for any observations. 
...
```
These histograms further the point of the Q-Q plot. In our introduction of this data int he term paper we will choose either the histograms or the Q-Q plots, and either the log-transformed or native scale variables to report. 

**Seasonal Evaluation of the TRAP variables concentrations:**

The stop-level data provided the date and week of the year that each sample was taken. To look at seasonal changes in the stop-level TRAP data, we need to separate the weeks of the year into four seasons. We did this by breaking up the roughly 52 weeks of the year into 4, ~14-week segments. 

Weeks 1 - 13 of the year are coded as spring
weeks 12 - 26 are coded as summer
weeks 27 - 39 are coded as autumn
and week 39 - 50 are coded as winter.

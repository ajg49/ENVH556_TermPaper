...
#native scale
ggplot(cal_nox, aes(sample_measurement)) +
...
#log transformed
ggplot(cal_nox, aes(log(sample_measurement))) +
...
#can we just drop them and say we dropped them becaues they are scientifically impossible?

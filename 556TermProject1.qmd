...
Blanco et al (2022) analyzed their short-term campaigns versus a gold standard using partial least squares (PLS), and had similar but slightly better results than our short term balanced and gold standard models. Blanco et al’s (2022) gold standard model had a MSE-based R squared of 0.46 and a RMSE of 7.2 ppb. The balanced, short-term model had the best R squared and RMSE out of all of the short-term campaigns, as well (Blanco et al. 2022). Although our gold standard model did not perform quite as well as the Blanco et al. (2022) PLS gold standard model, we believe our results support the same conclusions with the same data. 

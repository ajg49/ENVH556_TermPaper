...
#cross validation (random 10-fold) with Full2 linear model (day of the week)
...
for (i in 1:10){
    ...
    # fit the "common" model to the training set by omitting cluster i
    CV_lm <- lm(Full2, data = cv_pred, subset = !is_cluster)
...
# calculate the MSE, RMSE, MSE-based R2

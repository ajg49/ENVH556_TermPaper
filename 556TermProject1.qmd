...
```
Figure 4.0 shows the results from our cross validation of our gold standard data set and our common model. Using annual averages to predict across all 69 sensors. The models' MSE_based_R2 is 0.335, using data from across the state of California. We will compare our statewide balanced and seasonal campaigns with these performance statistics. 

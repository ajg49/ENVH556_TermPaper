...
```
#Running the prediction model on the lt_gold and st_balanced data
```{r}
...
long_term_gold <- mutate(long_term_gold, rando_CV_grp = CV_grp)
...
```{r}
gold_CV <- do_CV(long_term_gold, id = "native_id", group = "rando_CV_grp", formula = frml)

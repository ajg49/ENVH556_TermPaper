...
random_sample <- function(data, size) {  #specify the data frame and the number of samples to take from each monitor
  ...
  set.seed(72) # seed for reproducibility
  # Initialize a row index for sample_df
  row_index <- 1
...
test <- random_sample(nox_only, 28)
